...
interface IPostEditPage {
  params: {
    id: string;
  };
}

const PostEditpage = ({ params }: IPostEditPage) => {
  ...
  return (
    <>
      ...
      <div className="text-2xl mb-4">Edit Post</div>
      <Form {...form}>
        <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-8">
          ...
          />
          <Button className="dark:text-white dark:bg-slate-800 w-full ">
            Update
          </Button>
        </form>
      </Form>
